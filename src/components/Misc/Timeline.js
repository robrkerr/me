      ...
      <div className={styles.leftColumn}>
        ...
        <div style={{top: yearScale(2010.55), height: timeScale(3.5)}} className={styles.item}>
          <div className={styles.itemInner}>
            ...
            <div><Link text="University of Melbourne" href={urls.neuroEng}/></div>
          </div>
        </div>
      </div>
