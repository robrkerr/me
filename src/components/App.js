...
const sections = [
  ...
  {id: 'neuroscience', heading: 'I am a computational neuroscientist', bgColor: '#070b15', color: '#dfdfdf' },
  {id: 'web', heading: 'And more recently a web developer', bgColor: '#041a1a', color: '#dfdfdf' },
  {id: 'people', heading: 'I enjoy working with good people', bgColor: '#151019', color: '#dfdfdf' },
  {id: 'references', heading: 'I have people who can vouch for me', bgColor: 'hsl(236,10%,15%)', color: '#dfdfdf' }
]
